...
public:
    Table(sf::Texture inp_back_im, sf::Texture inp_slide_stick_im, sf::Texture inp_slider_im, sf::Vector2f inp_slider_offset, sf::Rect<float> text_zone, sf::Color inp_selected_color,\
    sf::Color inp_fill_color_default,sf::Vector2f inp_scale, sf::Vector2f inp_pos,  sf::Text inp_caption, \
     ...
     caption(inp_caption), handler(inp_handler), fill_color_default(inp_fill_color_default),selected_color(inp_selected_color){
               ...
               //text_table.setScale(scale_factor);
                text_table.setTextureRect(sf::IntRect(0,0,text_zone.width,text_zone.height));
